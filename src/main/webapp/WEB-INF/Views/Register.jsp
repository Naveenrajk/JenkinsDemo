	...
	<form action="PerformRegister" method="post">
		<table width="60%" align="center" class="table table-borderless w-50">
			...
			<tr>
				...
				<td><select class="form-control me-2" name="manufacture" id="cars">
			...
			<tr>
				<td><b>Kms Ran</b></td>
				<td><input type="number" placeholder="Kilometers" name="kmsRan"
					class="form-control me-2" required /></td>
			</tr>
			<tr>
				<td><b>Price Expected</b></td>
				<td><input type="number" placeholder="Price" name="priceExpected"
					class="form-control me-2" required /></td>
			</tr>
			<tr>
				<td><b>No of Owners</b></td>
				<td><input type="number" placeholder="Owners count"
